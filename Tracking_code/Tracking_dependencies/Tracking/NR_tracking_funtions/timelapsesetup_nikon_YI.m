function [firstgoodindex,blurthreshhigh,blurthreshlow,numthresh,badframes,height,width]=timelapsesetup_nikon_YI(rawdir,row, col, site, formatCode,frames,nucr,blobthreshold,debrisarea,badframes,maskwrite,nuc_channel)
